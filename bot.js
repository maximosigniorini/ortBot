...
let sonidos = ["Chano", "aparezco", "buenisimo", "fino", "niki", "a4", "aplaudo", "cortito", "hola", "privado", "acho", "basta", "cpiko", "jaram", "skate", "achotapita", "boa", "dios", "love", "traicionera", "ahre", "bob", "filisteo", "marina", "paco","casa","f","bolas","risa","bolas2"];
let imagenes = ["lobby"];
let misSonidos = [];
let isPlaying = false;
let comando = []
